...
function setFooter_FBButtonSize(){
	$(".footer_FBbutton").style = "border:none;overflow:hidden;margin-top:45px;margin-left: -52px;left: 50%;position: relative;";	
}
