...
<div id = "bodyDiv">
	<div  unselectable = "on" onselectstart="return false;" class = "sliderBack" onmousemove = "homeNormal()">
	...
	<div style = "z-index:96; padding-left:0px; position:relative; background:white;">
		...
		<div  unselectable = "on" onselectstart="return false;" class = "triangleContainer" onmousemove = "homeNormal()">
...
<script type="text/javascript">
	...
	feedbackTxt[0] = '<table feedbackFrame width = "100%" height = "130"><tr>' +
			...
			'<td class = "feedbackBlock" valign = "top">' +
				...
				'<div class = "feedbackProp"> &nbsp New york / 35 olds </div>' +
			...
			'<td class = "feedbackBlock" valign = "top">' +
				...
				'<div class = "feedbackBlank"></div>' +
				'<div class = "feedbackProp">&nbsp Toronto / 27 olds </div>' +
	...
	feedbackTxt[1] = '<table feedbackFrame width = "100%" height = "130"><tr>' +
			...
			'<td class = "feedbackBlock" valign = "top">' +
				...
				'<div class = "feedbackBlank"></div>' +
				'<div class = "feedbackProp">&nbsp Amsterdam / 52 olds </div>' +
			...
			'<td class = "feedbackBlock" valign = "top">' +
				...
				'<div class = "feedbackBlank"></div>' +
				'<div class = "feedbackProp">&nbsp Moscow / 27 olds </div>' +
	...
	feedbackTxt[2] = '<table feedbackFrame width = "100%" height = "130"><tr>' +
			...
			'<td class = "feedbackBlock" valign = "top">' +
				...
				'<div class = "feedbackBlank"></div>' +
				'<div class = "feedbackProp">&nbsp Shenyang / 43 olds </div>' +
			...
			'<td class = "feedbackBlock" valign = "top">' +
				...
				'<div class = "feedbackBlank"></div>' +
				'<div class = "feedbackProp">&nbsp Tokyo / 19 olds </div>' +
