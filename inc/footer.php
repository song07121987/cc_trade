			...
			<table class = "upFooter" cellspacing = "0">
				...
				<tr>
					...
					<td width = "32%" valign = "top">
						...
						<iframe class="footer_FBbutton" src="https://www.facebook.com/plugins/like.php?href=https%3A%2F%2Fwww.facebook.com%2Fcryptofirst%2F&width=125&layout=button&action=like&show_faces=false&share=true&height=65&appId" width="100" height="20" style="border:none;overflow:hidden;margin-top:45px;margin-bottom:45px;margin-left: -47px;left: 50%;position: relative;" scrolling="no" frameborder="0" allowTransparency="true"></iframe>
						...
						<table height = "100%">
							...
							<tr>
								<td class = "footerContactContent" align = "center" colspan = "2">
									<div  unselectable = "on" onselectstart="return false;" class = "emailLined2">
										<?php echo $sentences['temsConditionPrivacy'];?>
									</div>
								</td>
							</tr>
						</table>
